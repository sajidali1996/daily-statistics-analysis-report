...
% Calculate differences between consecutive uptime values
diffs = diff(uptime);

% Find indices where the uptime counter resets, but ignore rollovers from 65535 to 0
reset_indices = find(diffs < 0 & diffs ~= -65535);
